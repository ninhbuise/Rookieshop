package com.enashtech.rookieserver.security;

import com.enashtech.rookieserver.security.jwt.JwtAuthEntryPoint;
import com.enashtech.rookieserver.security.jwt.JwtAuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
            ...
            .authorizeRequests().antMatchers("/api/v1/").hasAnyRole("CUSTOMER", "STORE", "ADMIN")
            .antMatchers("/api/auth/**", "/api/v1/rookieshop").permitAll()
